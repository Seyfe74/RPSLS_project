...
class Game:
   ...
   def run_game(self):
      ...
      print("Rock, Paper, Scissors, Lizard, Spock is a new take on an old game.")
      print("Each player chooses a fighting gesture. The rules below explain the winning scenarios. The first player to win 2 rounds wins the game. Good Luck! ")
   ...
   def compare_choices (self):
         ...
         while (self.player_one_score < 2 and self.player_two_score < 2):
            player_one_chosen_gesture = self.player_one.get_choice()
            print ("Player one has chosen:   " + player_one_chosen_gesture)
            player_two_chosen_gesture = self.player_two.get_choice()
            print ("Player two has chosen:   " + player_two_chosen_gesture)
            ...
            if player_one_chosen_gesture == player_two_chosen_gesture :
               ...
               print (" It is Tie")
               print (" Round: " + str(self.game_round) ,  "  Player 1 Score: " + str(self.player_one_score) , " Player 2 Score: " + str(self.player_two_score)  )
               ...
               print (" Round: "  + str(self.game_round) ,  "Player One Score is: " + str(self.player_one_score) , "Player Two Score is: " + str(self.player_two_score)  )
